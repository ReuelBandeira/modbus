...
main(){
    ...
    message_header "V0.1: 13/11/2023 - Setup GW ISI 40 -Dev Env on Linux"
...
install_basic_software(){
    ...
    message_header "STEP 01/18 Linux bits update & upgrade"
    sudo apt update
    sudo apt -y upgrade


    message_header "STEP 02/18 Installing & configuring ufw"
    ...
    message_header "STEP 03/18 Installing git"
    sudo apt -y install git
	
    message_header "STEP 04/18 Installing GoLang"
