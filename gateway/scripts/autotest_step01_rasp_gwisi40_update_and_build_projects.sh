...
main(){
    ...
    echo "step01-0 Running Autoupdate v0.4 11-09-2023"

    echo "step01-1 Stopping services gateway, backend , emunewprotocol, mqtt and openvpn..."
    source ~/.profile
    cd lab
    sudo service gateway stop
    sudo service backend stop
    sudo service emunewprotocol stop
